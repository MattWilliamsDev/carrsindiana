...
function mosShowListMenu($menutype) {
	...
	echo $database->getErrorMsg();
		...
		while ($maxrecurse-- > 0) {
			...
			$indents = array(
		array( '<ul onmouseover="check_id()" id="navlist">', "\t<li>" , '</li>', '</ul>' ),
			array( "\t\t<ul onmouseover='check_id()'><li class='s5_toparrow'></li>", "\t\t\t<li class='noback'>" , '</li>', "\t\t<li class='s5_menubottom'></li></ul>" ),
			array( "\t\t<ul onmouseover='check_id()'><li class='s5_menutop'></li>", "\t\t\t<li>" , '</li>', "\t\t<li class='s5_menubottom'></li></ul>" ),
			array( "\t\t\t<ul onmouseover='check_id()'><li class='s5_menutop'></li>", "\t\t\t\t<li>" , '</li>', "\t\t\t<li class='s5_menubottom'></li></ul>" ),
			array( "\t\t\t\t<ul onmouseover='check_id()'><li class='s5_menutop'></li>", "\t\t\t\t\t<li>" , '</li>', "\t\t\t\t<li class='s5_menubottom'></li></ul>" ),
	);
