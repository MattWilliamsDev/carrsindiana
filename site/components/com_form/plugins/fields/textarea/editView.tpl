...
<div id="fragment-2">
     <table class="bfadminlist">
     	<tr>
     		...
     		<td><textarea cols="100" rows="10" class="inputbox bfinputbox" name="value" id="value">{$VALUE}</textarea></td>
     	</tr>
     	<tr>
...
<div id="fragment-2b">
	...
	<tr>
		<td><b>{bfText}Force submitted value to have upper case starting letters (Ucwords){/bfText}</b> <br />
		{bfText}Setting this to "Yes" will return the value after it has been made to have Uppercase first chars of every word{/bfText}
		<td>{$FILTER_UCWORDS} <br />
		<b>{bfText}Default: No{/bfText}<b></td>
	</tr>
     </table>
...
<div id="fragment-4"><!--  Style -->
 <table class="bfadminlist">
     	...
     	<tr>
     		<td><b>{bfText}Text Area Columns Size{/bfText}</b> <br />
     		{bfText}The value of the field's cols attribute, should be an integer.  Default: 40{/bfText}</td>
     		<td><input size="4" class="inputbox" type="text"
     			value="{$COLS}" name="cols" id="cols" /></td>
     	</tr>
     	<tr>
     		<td><b>{bfText}Text Area Rows Size{/bfText}</b> <br />
     		{bfText}The value of the field's rows attribute, should be an integer.  Default: 10{/bfText}</td>
     		<td><input size="4" class="inputbox" type="text"
     			value="{$ROWS}" name="rows" id="rows" /></td>
     	</tr>
     	<tr>
     		<td><b>{bfText}Input Maxlength{/bfText}</b> <br />
     		{bfText}The maxlength attribute of the field's input element, should be an integer.  Default: 255{/bfText}</td>
     		<td><input size="4" class="inputbox bfinputbox" type="text"
     			value="{$MAXLENGTH}" name="maxlength" id="maxlength" /></td>
     	</tr>
     	<tr>
     		<td><b>{bfText}Enable Manual "drag to change height" if text area{/bfText}</b> <br />
     		{bfText}If this is enabled then a grabrail will be added to allow users to change the height of the textarea{/bfText}</td>
     		<td>{$OPTION1}</td>
     	</tr>
     	<!-- 
     	<tr>
     		<td><b>{bfText}Enable Autogrow (Cannot be used at the same time as Manual drag above){/bfText}</b> <br />
     		{bfText}If this is enabled then the textarea will magically grow as the user types{/bfText}</td>
     		<td>{$OPTION2}</td>
     	</tr>
     	-->
     </table>
