<?php
/**
 * @version $Id: selectusastates.php 184 2010-01-03 20:44:13Z  $
 ...
 *
 */
final class plugins_fields_selectusastates extends plugins_fields_base {
	 ...
	 */
	public $_title = 'Drop Down List: Prepopulated with all USA States';
	 ...
	 * @var array The defaults
	 */
	public $_creation_defaults = array ('plugin' => 'selectusastates', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'size' => '1', 'class' => 'inputbox', 'form_id' => '-1', 'type' => 'select', 'verify_isinarray' => '' );
	 ...
	 */
	public $_desc = 'A Drop Down With USA States as Options';
	...
	public function __construct() {
		$states = array ("Alabama", "Alaska", "Arizona", "Arkansas", "California", "Colorado", "Connecticut", "Delaware", "Columbia (District of)", "Florida", "Georgia", "Hawaii", "Idaho", "Illinois", "Indiana", "Iowa", "Kansas", "Kentucky", "Louisiana", "Maine", "Maryland", "Massachusetts", "Michigan", "Minnesota", "Mississippi", "Missouri", "Montana", "Nebraska", "Nevada", "New Hampshire", "New Jersey", "New Mexico", "New York", "North Carolina", "North Dakota", "Ohio", "Oklahoma", "Oregon", "Pennsylvania", "Rhode Island", "South Carolina", "South Dakota", "Tennessee", "Texas", "Utah", "Vermont", "Virginia", "Washington", "West Virginia", "Wisconsin", "Wyoming" );

		$this->_creation_defaults ['params'] = implode ( "\n", $states );
		//		$this->_creation_defaults ['verify_inarray'] = implode ( ',', $states  );
