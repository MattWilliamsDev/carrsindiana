...
<table class="bfadminlist">
	<tr>
		<td><b>{bfText}Checkbox Options{/bfText}</b> <br />
		{bfText}Enter the values for each checkbox, one box per line, bar separated values.<br />
		Eg.:<br />
	...
	<tr>
		...
		{bfText}Write the VALUE of the boxes you want checked by default, if there is more than one separate them by commas.  Eg from above:  Fishing,UP{/bfText}</td>
		<td><input size="100" class="inputbox bfinputbox" type="text"
