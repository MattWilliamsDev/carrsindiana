...
<fieldset><legend>More Rules</legend>
	...
	<table class="bfadminlist">
	    <tr>
        <td><b>{bfText}Input MUST be an email address that matches one of these domains.{/bfText}</b>
        <br />
        {bfText}Use commas to separate the values (e.g. domain1.com, domain2.com, etc.){/bfText}</td>
        <td><input type="text" value="{$VERIFY_ISALLOWEDDOMAIN}" id="verify_isalloweddomain"
            name="verify_isalloweddomain" /></td>
    </tr>

    <tr>
        <td><b>{bfText}Input MUST NOT be an email address that matches one of these domains.{/bfText}</b>
        <br />
        {bfText}Use commas to separate the values (e.g. domain1.com, domain2.com, etc.){/bfText}</td>
        <td><input type="text" value="{$VERIFY_ISDENIEDDOMAIN}" id="verify_isdenieddomain"
            name="verify_isdenieddomain" /></td>
    </tr>
		<tr>
