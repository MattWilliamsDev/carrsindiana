<?php
/**
 * @version $Id: selectrating.php 184 2010-01-03 20:44:13Z  $
 ...
 *
 */
final class plugins_fields_selectrating extends plugins_fields_base {
	 ...
	 */
	public $_title = 'Drop Down List: Prepopulated Excellent - Very Poor ratings';
	 ...
	 * @var array The defaults
	 */
	public $_creation_defaults = array ('plugin' => 'selectrating', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'size' => '1', 'class' => 'inputbox', 'form_id' => '-1', 'type' => 'select', 'verify_isinarray' => '' );
	 ...
	 */
	public $_desc = 'A Drop Down With Excellent - Very Poor ratings as Options';
	...
	public function __construct() {
		...
		$this->_creation_defaults ['style'] = 'width:100px;';
