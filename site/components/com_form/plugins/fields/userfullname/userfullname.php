<?php
/**
 * @version $Id: userfullname.php 147 2009-07-14 20:20:18Z  $
 ...
 *
 */
class plugins_fields_userfullname extends plugins_fields_base {
	 ...
	 */
	var $_title = 'Pre-Filled With Logged In Users Full Name - Visible Field';
	 ...
	 * @var array The defaults
	 */
	var $_creation_defaults = array ('plugin' => 'userfullname', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'maxlength' => '255', 'type' => 'text', 'form_id' => '-1' );
	 ...
	 */
	var $_desc = 'A visible field prefilled with the logged in user\'s full name, cannot be changed by the user';
	...
	public function toString() {
		...
		if ($val && $this->_config ['allowsetbyget'] == '1') {
			...
			$this->_attributes ['value'] = $user->get ( 'name' ) ? $user->get ( 'name' ) : '';
		}
	...
	public function postProcess() {
		...
		$this->setSubmittedValue ( $user->get ( 'name' ) );
	}
}
?>