<?php
/**
 * @version $Id: timestamp.php 165 2009-08-02 20:37:23Z  $
 ...
 *
 */
final class plugins_fields_timestamp extends plugins_fields_base {
	 ...
	 */
	public $_title = 'TimeStamp - Hidden field with the forms submitted timestamp';
	 ...
	 * @var array The defaults
	 */
	public $_creation_defaults = array ('type' => 'hidden', 'value'=>'D M j G:i:s T Y','plugin' => 'timestamp', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'maxlength' => '255', 'size' => '30', 'class' => 'inputbox', 'form_id' => '-1' );
	 ...
	 */
	public $_desc = 'A Hidden field that, on submission, contains the timestamp';
...
//			$html .= '<span class="required">*</span>';
	...
	public function postProcess() {
				$this->setSubmittedValue(date($this->_attributes ['value']));
	}
}