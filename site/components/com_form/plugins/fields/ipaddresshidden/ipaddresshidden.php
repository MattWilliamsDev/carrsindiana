<?php
/**
 * @version $Id: ipaddresshidden.php 165 2009-08-02 20:37:23Z  $
 ...
 *
 */
final class plugins_fields_ipaddresshidden extends plugins_fields_base {
	 ...
	 */
	public $_title = 'IP Address (Hidden) - Collects the users IP address in a hidden field';
	 ...
	 * @var array The defaults
	 */
	public $_creation_defaults = array ('plugin' => 'ipaddresshidden', 'verify_isipaddress' => '1', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'maxlength' => '255', 'size' => '50', 'class' => 'inputbox', 'form_id' => '-1', 'type' => 'hidden' );
	 ...
	 */
	public $_desc = 'This stores the users IP Address in a hidden field';
