<?php
/**
 * @version $Id: textbox.php 131 2009-04-16 21:31:04Z  $
 ...
 *
 */
final class plugins_fields_embeddedpagetitle extends plugins_fields_base {
	 ...
	 * @var unknown_type
	 */
	public $_pname = 'embeddedpagetitle';
	 ...
	 */
	public $_title = 'embeddedpagetitle - Store the page title of the content item that a form is embedded into';
	 ...
	 * @var array The defaults
	 */
	public $_creation_defaults = array ('plugin' => 'embeddedpagetitle', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'maxlength' => '255', 'size' => '30', 'class' => 'inputbox', 'form_id' => '-1', 'type' => 'hidden' );
	 ...
	 */
	public $_desc = 'Store the page title of the content item that a form is embedded into';
	...
	public function toString() {
		...
		$this->_attributes ['value'] = $mainframe->get ( 'BF_ARTICLE_TITLE' );
