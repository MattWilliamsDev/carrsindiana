<?php
/**
 * @version $Id: useremailaddresshidden.php 147 2009-07-14 20:20:18Z  $
 ...
 *
 */
class plugins_fields_useremailaddresshidden extends plugins_fields_base {
	 ...
	 * @var unknown_type
	 */
	var $_pname = 'useremailaddresshidden';
	 ...
	 */
	var $_title = 'Pre-Filled With Logged In Users Emailaddress - Hidden Field';
	 ...
	 * @var array The defaults
	 */
	var $_creation_defaults = array ('plugin' => 'useremailaddresshidden', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'verify_isemailaddress' => '1', 'maxlength' => '255', 'type' => 'hidden', 'form_id' => '-1' );
	 ...
	 */
	var $_desc = 'A hidden field prefilled with the logged in user\'s emailaddress';
