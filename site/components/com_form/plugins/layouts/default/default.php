<?php
/**
 * @version $Id: default.php 184 2010-01-03 20:44:13Z  $
...
/**
 * I am the class for a layout/painter
 * @author Blue Flame IT Ltd
 *
 */
final class plugins_layouts_default extends PluginLayoutBase {
	...
	public function _setHeadData() {
		...
		/* set meta data */
		bfCompat::addCSS ( bfcompat::getLiveSite () . '/components/com_form/plugins/layouts/default/default.css' );
	}
	...
	public function onRenderForm() {
		...
		$user = bfUser::getInstance();
		if ($this->_FORM_CONFIG ['allowpause'] == "1" && $user->get('id') > 0){
			$tmp->assign ( 'SHOW_PAUSE_BUTTON', 1 );
		}
