<?php
/**
 * @version $Id: actions.php 147 2009-07-14 20:20:18Z  $
...
$controller->setPageTitle ( bfText::_ ( 'Form Actions' ) );
$controller->setPageHeader ( bfText::_ ( 'Form Actions' ) );

/* Create a toolbar, or use a deafult index type toolbar */
$toolbar = bfToolbar::getInstance ( $controller );
$toolbar->addButton ( 'new', 'add', bfText::_ ( 'Click here to create a new action' ) );
...
bfHTML::drawIndexTable ( $action, false, $controller->getView () );
?>