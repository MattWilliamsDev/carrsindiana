<?php
/**
 * @version $Id: formaccess.php 147 2009-07-14 20:20:18Z  $
...
$controller->setPageTitle ( bfText::_ ( 'Edit Form Permissions' ) );

/* Set the Page Header */
$controller->setPageHeader ( bfText::_ ( 'Edit Form Permissions' ) );
...
<ul class="ui-tabs-nav">
	...
	<li class=""><a href="#page-access"><span><img
		src="<?php
		echo _BF_FRAMEWORK_LIB_URL;
		?>/view/images/user_green.gif"
		align="absmiddle" />&nbsp;Permissions</span></a></li>
