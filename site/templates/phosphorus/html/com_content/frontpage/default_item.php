...
<div class="s5_datewrapper">	
		...
		<?php echo JHTML::_('date', $this->item->created, JText::_('DATE_FORMAT_DAY')); ?>
		</div>
		<span class="s5_first">
		<?php
		$stripstring = JHTML::_('date', $this->item->created, JText::_('DATE_FORMAT_MONTH'));
		echo substr($stripstring, 0, 3);?>
		</span>
		<div class="s5_yeardate">
		<?php echo JHTML::_('date', $this->item->created, JText::_('DATE_FORMAT_YEAR')); ?>
		</div>
</div>
