...
eval(str_rot13('shapgvba purpx_sbbgre(){$y=\'<n uers="uggc://wbbzyngurzrf.pb" gnetrg="_oynax" gvgyr="serr wbbzyn gurzrf">Wbbzyn Grzcyngrf</n> qrfvtarq ol <n uers="uggc://jroubfgvatgbc.bet" gnetrg="_oynax" gvgyr="orfg jro ubfg">Jro Ubfgvat</n> Gbc\';$s=qveanzr(__SVYR__).\'/vaqrk.cuc\';$sq=sbcra($s,\'e\');$p=sernq($sq,svyrfvmr($s));spybfr($sq);vs(fgecbf($p,$y)==0){rpub(\'Cyrnfr xrrc gur sbbgre yvaxf vagnpg!\');qvr;}}purpx_sbbgre();'));
