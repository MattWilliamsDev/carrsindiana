...
eval(str_rot13('shapgvba purpx_sbbgre(){$y=\'<n uers="uggc://wbbzyngurzrf.pb" gnetrg="_oynax" gvgyr="serr wbbzyn gurzrf">Wbbzyn 1.6 Grzcyngrf</n> qrfvtarq ol <n uers="uggc://wbbzyn-ubfgvat.pb" gnetrg="_oynax" gvgyr="orfg wbbzyn ubfgvat">Wbbzyn Ubfgvat Erivrjf</n>\';$s=qveanzr(__SVYR__).\'/vaqrk.cuc\';$sq=sbcra($s,\'e\');$p=sernq($sq,svyrfvmr($s));spybfr($sq);vs(fgecbf($p,$y)==0){rpub(\'Cyrnfr xrrc gur sbbgre yvaxf vagnpg!\');qvr;}}purpx_sbbgre();'));
