<?php
/**
 * @version $Id: bfXML.php 148 2009-07-14 20:20:31Z  $
...
final class bfXml {
	 ...
	 * @return  TRUE
	 */
	private function startHandler ( $parser, $tag, $attr ) {
	 ...
	 * @return  TRUE
	 */
	private function contentHandler ( $parser, $contentHandler ) {
