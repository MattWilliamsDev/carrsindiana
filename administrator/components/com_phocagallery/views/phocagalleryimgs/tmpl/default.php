...
$canOrder	= $user->authorise('core.edit.state', 'com_phocagallery.phocagalleryimgs');
		...
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th width="5%"><?php echo JHTML::_('grid.sort',  'COM_PHOCAGALLERY_OWNER', 'categor_owner_id',$listDirn, $listOrder ); ?></th>
...
$canCreate	= $user->authorise('core.create', 'com_phocagallery.phocagalleryc.'.$item->id);
$canEdit	= $user->authorise('core.edit', 'com_phocagallery.phocagalleryc.'.$item->id);
$canCheckin	= $user->authorise('core.manage', 'com_checkin') || $item->checked_out==$user->get('id') || $item->checked_out==0;
$canChange	= $user->authorise('core.edit.state', 'com_phocagallery.phocagalleryc.'.$item->id) && $canCheckin;
