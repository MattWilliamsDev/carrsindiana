...
<form action="<?php echo JRoute::_('index.php?option=com_phocagallery&view=phocagalleryra'); ?>" method="post" name="adminForm" id="adminForm">
...
$canEditCat	= $user->authorise('core.edit', 'com_phocagallery.phocagalleryc.'.$item->category_id);
?>
