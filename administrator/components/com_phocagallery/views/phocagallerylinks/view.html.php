...
class phocaGalleryCpViewphocaGalleryLinks extends JView
{
	function display($tpl = null) {
		...
		$tmpl['COM_PHOCAGALLERY_CATEGORIES']		= 'index.php?option=com_phocagallery&amp;view=phocagallerylinkcats&amp;tmpl=component&amp;e_name='.$eName;
		...
		$tmpl['COM_PHOCAGALLERY_SLIDESHOW']		= 'index.php?option=com_phocagallery&amp;view=phocagallerylinkimg&amp;type=4&amp;tmpl=component&amp;e_name='.$eName;
