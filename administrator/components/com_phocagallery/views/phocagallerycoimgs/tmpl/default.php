...
$canOrder	= $user->authorise('core.edit.state', 'com_phocagallery.phocagallerycoimgs');
...
$canEditImg	= $user->authorise('core.edit', 'com_phocagallery.phocagalleryimg.'.(int)$item->image_id);
$date		= JHTML::_('date',  $item->date, JText::_('DATE_FORMAT_LC2') );
$canCheckin	= $user->authorise('core.manage',		'com_checkin') || $item->checked_out==$user->get('id') || $item->checked_out==0;
$canChange	= $user->authorise('core.edit.state',	'com_phocagallery.phocagallerycoimgs.'.$item->category_id) && $canCheckin;
$canCreate	= $user->authorise('core.create',		'com_phocagallery.phocagallerycoimgs.'.$item->category_id);
?>
