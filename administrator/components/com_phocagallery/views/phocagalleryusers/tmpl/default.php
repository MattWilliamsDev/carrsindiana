...
$canOrder	= $user->authorise('core.edit.state', 'com_phocagallery.phocagalleryusers');
...
$canChange	= $user->authorise('core.edit.state',	'com_phocagallery.phocagalleryusers') && $canCheckin;
