...
$canOrder	= $user->authorise('core.edit.state', 'com_phocagallery.phocagallerycs');
...
$canEditParent	= $user->authorise('core.edit', 'com_phocagallery.phocagalleryc.'.(int)$item->parent_id);
