<?php
/**
 * @version $Id: radio.php 147 2009-07-14 20:20:18Z  $
 ...
 *
 */
final class plugins_fields_radio extends plugins_fields_base {
	 ...
	 */
	public $_title = 'radio - A Simple radio button group';
	 ...
	 * @var array The defaults
	 */
	public $_creation_defaults = array ('plugin' => 'radio', 'value' => "yes|Click for YES\nno|Click For No", 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'maxlength' => '255', 'size' => '30', 'rows' => '3', 'class' => 'inputbox', 'form_id' => '-1', 'type' => 'radio' );
	 ...
	 */
	public $_desc = 'Single or multiple radio boxes, horizontal or vertical';
	...
	public function toString() {
		...
		foreach ( $values as $value ) {
			...
			if (isset($value [1]))
			$htmlArr [] = '<label class="bf_layout_checkbox">' . sprintf ( $this->_barehtml, $attributesSpacedHTML ) . $value [1] . '</label>';
			if ($this->_config ['layoutoption'] == '1') {
