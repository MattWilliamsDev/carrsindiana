<?php
/**
 * @version $Id: useremailaddress.php 147 2009-07-14 20:20:18Z  $
 ...
 *
 */
class plugins_fields_useremailaddress extends plugins_fields_base {
	 ...
	 */
	var $_title = 'Pre-Filled With Logged In Users Emailaddress - Visible Field';
	 ...
	 */
	public $_attributes = array ('type' => 'text', 'id' => '', 'name' => '', 'maxlength' => '255', 'size' => '50', 'class' => 'inputbox', 'value' => '', 'style' => '', 'onblur' => '' );
	 ...
	 * @var array The defaults
	 */
	var $_creation_defaults = array ('plugin' => 'useremailaddress', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'maxlength' => '255', 'verify_isemailaddress' => '1', 'type' => 'text', 'form_id' => '-1' );
	 ...
	 */
	var $_desc = 'A visible field prefilled with the logged in user\'s emailaddress';
	 ...
	 * @var unknown_type
	 */
	var $_extendSQL = 'ALTER TABLE `%s` ADD `%s` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL ;';
	...
	public function toString() {
		...
		if ($val && $this->_config ['allowsetbyget'] == '1') {
			...
			$this->_attributes ['value'] = $user->get ( 'email' ) ? $user->get ( 'email' ) : '';
		}
	...
	public function postProcess() {
		...
		$this->setSubmittedValue ( $user->get ( 'email' ) );
	}
}
?>