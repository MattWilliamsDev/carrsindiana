<?php
/**
 * @version $Id: userfullnamehidden.php 147 2009-07-14 20:20:18Z  $
 ...
 *
 */
class plugins_fields_userfullnamehidden extends plugins_fields_base {
	 ...
	 */
	var $_title = 'Pre-Filled With Logged In User\'s Full Name - Hidden Field';
	 ...
	 * @var array The defaults
	 */
	var $_creation_defaults = array ('plugin' => 'userfullnamehidden', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'maxlength' => '255', 'type' => 'hidden', 'form_id' => '-1' );
