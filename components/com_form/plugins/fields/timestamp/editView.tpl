...
<table class="bfadminlist">
	<tr>
		<td><b>{bfText}Date Format{/bfText}</b> <br />
		{bfText}Take a look at <a href="http://www.php.net/date">http://www.php.net/date</a> for examples, you dont need the quotes just the format.{/bfText}</td>
		<td><input size="100" class="inputbox bfinputbox" type="text"
