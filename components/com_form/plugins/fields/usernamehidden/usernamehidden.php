<?php
/**
 * @version $Id: usernamehidden.php 147 2009-07-14 20:20:18Z  $
 ...
 *
 */
class plugins_fields_usernamehidden extends plugins_fields_base {
	 ...
	 */
	var $_title = 'Pre-Filled With Logged In Username - Hidden Field';
	 ...
	 */
	var $_attributes = array ('id' => '', 'name' => '', 'value' => '', 'type' => 'hidden' );
	 ...
	 * @var array The defaults
	 */
	var $_creation_defaults = array ('plugin' => 'usernamehidden', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'maxlength' => '255', 'type' => 'hidden', 'form_id' => '-1' );
	 ...
	 */
	var $_desc = 'A hidden field prefilled with the logged in user\'s username, cannot be changed by the user';
