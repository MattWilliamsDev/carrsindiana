...
<table class="bfadminlist">
	...
	<tr>
		...
		<b>{bfText}This must be unique in this form, this means you cannot have two elements with the same system name!!!<br />You should also keep this quite short, for example: "myipaddress"{/bfText}</b></td>
	</tr>
	<tr>
...
<div id="fragment-4"><!--  Style -->
 <table class="bfadminlist">
     	...
     	<tr>
     		...
     		{bfText}The size attribute of the field's input element, should be an integer.  Default: 30{/bfText}</td>
