 ...
 *
 */
final class plugins_fields_submit extends plugins_fields_base {
	 ...
	 */
	public $_attributes = array ('type' => 'submit', 'id' => '', 'name' => '', 'class' => 'inputbox', 'value' => 'Send Form', 'style' => '', 'onblur' => '' );
	 ...
	 * @var array The defaults
	 */
	public $_creation_defaults = array ('plugin' => 'submit', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'maxlength' => '255', 'size' => '30', 'class' => 'inputbox', 'form_id' => '-1', 'type' => 'submit', 'value' => 'Send Form' );
	 ...
	 */
	public $_desc = 'The most basic submit button field';
	...
	public function toString() {
		...
		$this->_attributes ['onclick'] = 'bf_form.formSubmit(\''.$this->_config['form_id'].'\');return false;';
