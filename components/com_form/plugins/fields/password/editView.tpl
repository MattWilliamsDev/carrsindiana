...
<div id="fragment-2a">
	 <table class="bfadminlist">
     	<tr>
     		...
     		{bfText}Setting this to "Yes" will force this field to be a required field{/bfText}</td>
     		<td>{$REQUIRED}</td>
     	</tr>
     </table>
...
<table class="bfadminlist">
     	...
     	<tr>
     		...
     		<td>{$ALLOWBYEMAIL} <br /><b>{bfText}Default: No{/bfText}<b></td>
     	</tr>
...
<div id="fragment-4"><!--  Style -->
 <table class="bfadminlist">
 		<tr>
     		<td><b>{bfText}Show Password Strength Meter{/bfText}</b> <br />
     		{bfText}Setting this to "Yes" display a visual meter of the password stregnth<br /><strong> THIS DOES NOT FORCE THE PASSWORD TO BE MORE SECURE, AND IS A VISUAL INDICATION ONLY</strong>{/bfText}</td>
     		<td>{$PARAMS}</td>
     	</tr>
     	<tr>
     	...
     	<tr>
     		...
     		{bfText}The size attribute of the field's input element, should be an integer.  Default: 50{/bfText}</td>
