<?php
/**
 * @version $Id: username.php 147 2009-07-14 20:20:18Z  $
 ...
 *
 */
class plugins_fields_username extends plugins_fields_base {
	 ...
	 */
	var $_title = 'Pre-Filled With Logged In Username - Visible Field';
	 ...
	 * @var array The defaults
	 */
	var $_creation_defaults = array ('plugin' => 'username', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'maxlength' => '255', 'type' => 'text', 'form_id' => '-1' );
	 ...
	 */
	var $_desc = 'A visible field prefilled with the logged in user\'s username, cannot be changed by the user';
	...
	public function toString() {
		...
		if ($val && $this->_config ['allowsetbyget'] == '1') {
			...
			$this->_attributes ['value'] = $user->get ( 'username' ) ? $user->get ( 'username' ) : 'NOT LOGGED IN';
		}
	...
	public function postProcess() {
		...
		$this->setSubmittedValue ( $user->get ( 'username' ) );
	}
}
?>