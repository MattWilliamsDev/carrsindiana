<?php
/**
 * @version $Id: selectaustralianstates.php 184 2010-01-03 20:44:13Z  $
 ...
 *
 */
final class plugins_fields_selectaustralianstates extends plugins_fields_base {
	 ...
	 * @var unknown_type
	 */
	public $_pname = 'selectaustralianstates';
	 ...
	 */
	public $_title = 'Drop Down List: Prepopulated with Australian States';
	 ...
	 */
	public $_desc = 'A Drop Down With Australian States as Options';
	...
	public function __construct() {
		$states = array ("Australian Capital Territory", "New South Wales", "Northern Territory", "Queensland", "South Australia", "Tasmania", "Victoria", "West Australia" );
		...
		$this->_creation_defaults ['verify_isinarray'] = implode ( ',', $states );
