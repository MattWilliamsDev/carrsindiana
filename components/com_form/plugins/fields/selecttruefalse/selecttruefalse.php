<?php
/**
 * @version $Id: selecttruefalse.php 184 2010-01-03 20:44:13Z  $
 ...
 *
 */
final class plugins_fields_selecttruefalse extends plugins_fields_base {
	 ...
	 */
	public $_title = 'Drop Down List: Prepopulated with True False';
	 ...
	 * @var array The defaults
	 */
	public $_creation_defaults = array ('plugin' => 'selecttruefalse', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'size' => '1', 'class' => 'inputbox', 'form_id' => '-1', 'type' => 'select', 'verify_isinarray' => 'true,false' );
	 ...
	 */
	public $_desc = 'A Drop Down With True and False as Options';
