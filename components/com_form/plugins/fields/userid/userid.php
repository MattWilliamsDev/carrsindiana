<?php
/**
 * @version $Id: userid.php 147 2009-07-14 20:20:18Z  $
 ...
 *
 */
class plugins_fields_userid extends plugins_fields_base {
	 ...
	 */
	var $_title = 'Pre-Filled With Logged In Users ID - Visible Field';
	 ...
	 * @var array The defaults
	 */
	var $_creation_defaults = array ('plugin' => 'userid', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'maxlength' => '255', 'type' => 'text', 'verify_isinteger' => '1', 'filter_alnum' => '1', 'form_id' => '-1' );
	 ...
	 */
	var $_desc = 'A visable field prefilled with the logged in user\'s id number, cannot be changed by the user';
	 ...
	 * @var unknown_type
	 */
	var $_extendSQL = 'ALTER TABLE `%s` ADD `%s` INT( 11 ) NOT NULL ;';
