<?php
/**
 * @version $Id: selectonetohundred.php 184 2010-01-03 20:44:13Z  $
 ...
 *
 */
final class plugins_fields_selectonetohundred extends plugins_fields_base {
	 ...
	 * @var unknown_type
	 */
	public $_pname = 'selectonetohundred';
	 ...
	 */
	public $_title = 'Drop Down List: Prepopulated with numbers 1-100';
	 ...
	 * @var array The defaults
	 */
	public $_creation_defaults = array ('plugin' => 'selectonetohundred', 'published' => '1', 'access' => '0', 'allowbyemail' => '1', 'size' => '1', 'class' => 'inputbox', 'form_id' => '-1', 'type' => 'select', 'verify_isinarray' => '' );
	 ...
	 */
	public $_desc = 'A Drop Down With numbers from 1-100 as Options';
	 ...
	 * @var unknown_type
	 */
	public $_extendSQL = 'ALTER TABLE `%s` ADD `%s` INT( 11 ) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL ;';
	...
	public function __construct() {
		...
		$this->_creation_defaults ['style'] = 'width:80px;';
		$this->_creation_defaults ['verify_isinarray'] = implode ( ',', explode ( "\n", $params ) );
		$this->_creation_defaults ['required'] = '1';
		$this->_creation_defaults ['filter_Digits'] = '1';
