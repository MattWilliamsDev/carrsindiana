...
<div id="bfTabs">
	...
	<div id="fragment-2"><!--  Options -->
	 	<table class="bfadminlist">
	 			<tr>
		     		<td valign="top"><b>{bfText}API Key{/bfText}</b> <br />
		     		{bfText}Your Mailchimp API Key{/bfText}</td>
		     		<td width="50%"><input class="inputbox" type="text" value="{$CUSTOM4}" name="custom4" id="custom4" style="width:300px;"/></td>
		     	</tr>
		     	<tr>
		     		<td valign="top"><b>{bfText}List To Subscribe/Unsubscribe To{/bfText}</b> <br />
		     		{bfText}Select the group you want the submitter to be signed up to - If none appear here make sure you have entered your Mailchimp API Key andd saved this action and then come back here{/bfText}</td>
