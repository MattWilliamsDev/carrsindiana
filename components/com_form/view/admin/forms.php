<?php
/**
 * @version $Id: forms.php 147 2009-07-14 20:20:18Z  $
...
$controller->setPageTitle ( bfText::_ ( 'Your Forms' ) );
$controller->setPageHeader ( bfText::_ ( 'Your Forms' ) );

/* Create a toolbar, or use a deafult index type toolbar */
$toolbar = bfToolbar::getInstance ( $controller );
$toolbar->addButton ( 'new', 'add', bfText::_ ( 'Click here to create a new form' ) );
...
bfHTML::drawIndexTable ( $form, false, $controller->getView () );
?>