...
if (!empty($this->items)) {
	foreach($this->items as $key => $value) {
		...
		//Detail Icon	
			if ($value->displayicondetail == 1) {
				echo ' <a class="'.$value->button2->methodname.'" title="'. JText::_('COM_PHOCAGALLERY_IMAGE_DETAIL').'"'
					.' href="'.$value->link2.'"';
					if ($this->tmpl['detailwindow'] == 1) {
					...
					echo ' >';
					echo JHTML::_('image', 'components/com_phocagallery/assets/images/icon-view.'.$this->tmpl['formaticon'], JText::_('COM_PHOCAGALLERY_IMAGE_DETAIL'));
					echo '</a>';
			}
			...
			if ($value->displayicondownload > 0) {
				...
				if ($value->displayicondownload == 2 && $value->videocode == '') {
					echo ' <a title="'. JText::_('COM_PHOCAGALLERY_IMAGE_DOWNLAD').'"'
					...
					echo ' <a class="'.$value->buttonother->methodname.'" title="'.JText::_('COM_PHOCAGALLERY_IMAGE_DOWNLAD').'"'
				...
				echo ' >';
				echo JHTML::_('image', 'components/com_phocagallery/assets/images/icon-download.'.$this->tmpl['formaticon'], JText::_('COM_PHOCAGALLERY_IMAGE_DOWNLAD'));
				echo '</a>';
			}
