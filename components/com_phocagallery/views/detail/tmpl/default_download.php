...
if ($this->tmpl['backbutton'] != '') {
	...
	echo '<tr><td align="left"><a title="'. JText::_('COM_PHOCAGALLERY_IMAGE_DOWNLAD').'" href="'. JRoute::_('index.php?option=com_phocagallery&view=detail&catid='.$this->item->catslug.'&id='.$this->item->slug.'&phocadownload=2'.'&Itemid='. JRequest::getVar('Itemid', 0, '', 'int') ).'">'.JText::_('COM_PHOCAGALLERY_IMAGE_DOWNLAD').'</a></td><td>&nbsp;</td>';
