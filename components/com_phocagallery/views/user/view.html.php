...
class PhocaGalleryViewUser extends JView
{
	...
	function display($tpl = null) {
		...
		$this->tmpl['gallerymetakey'] 		= $params->get( 'gallery_metakey', '' );
		$this->tmpl['gallerymetadesc'] 		= $params->get( 'gallery_metadesc', '' );
		...
		$this->tmpl['maxuploadchar']		= $params->get( 'max_upload_char', 1000 );
		$this->tmpl['maxcreatecatchar']		= $params->get( 'max_create_cat_char', 1000 );
		$this->tmpl['dp'] 					= PhocaGalleryRenderInfo::getPhocaIc((int)$params->get( 'display_phoca_info', 1 ));
		$this->tmpl['showpageheading'] 		= $params->get( 'show_page_heading', 1 );

		$this->tmpl['javaboxwidth'] 		= $params->get( 'java_box_width', 480 );
		$this->tmpl['javaboxheight'] 		= $params->get( 'java_box_height', 480 );
		$this->tmpl['enableuploadavatar'] 	= $params->get( 'enable_upload_avatar', 1 );
		...
		$this->tmpl['displaytitleupload']	= $params->get( 'display_title_upload', 0 );
		$this->tmpl['displaydescupload'] 	= $params->get( 'display_description_upload', 0 );
		...
		$this->tmpl['usersubcatcount']		= $params->get( 'user_subcat_count', 5 );
		$this->tmpl['userimagesmaxspace']	= $params->get( 'user_images_max_size', 20971520 );
